...
import sun.net.ftp.FtpClient;
	...
	public class FtpTest {
		...
		public FtpTest(String ip, int port, String username,
				String password)
		...
		public FtpTest(String ip, String username, String password)
		...
		/**
		 * 
		 * JSP中的流上传到FTP服务器, 上传文件只能使用二进制模式，当文件存在时再次上传则会覆盖
		 * 字节数组做为文件的输入流,此方法适用于JSP中通过
		 * 
		 * request输入流来直接上传文件在RequestUpload类中调用了此方法，destination路径以FTP服务器的"/"开始，
		 * 带文件名
		 * 
		 * 
		 * 
		...
		public void upFile(byte[] sourceData, String destination)
				throws Exception {
		...
		public static void main(String[] args) throws Exception {
			...
			FtpTest ftp = new FtpTest("13.249.13.5", 21,
					"esb", "esb123");
			 ...
			 * 
			 * Settings\\Administrator\\My Documents\\SetupDJ.rar",
			 * destination);
			 * 
			 * ArrayList filename = fUp.fileNames("/"); for (int i = 0; i <
			 * 
...
/*			fin.read(data, 0, data.length);
			...
			ftp.upFile(data, "/home/cdr/wapPush.txt");*/
			//ftp.downFile("/home/test/WMQ_6023/readadd.txt", "d:\\1111.txt");
			ftp.upFile("d:\\1111.txt", "/home/test/WMQ_6023/1111.txt");
			ftp.logout();
